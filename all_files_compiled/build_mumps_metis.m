function build_mumps_metis(target_arith)
    ...
    sys_libs = sprintf('-L. -llibmx -llibmex -llibmat -L%s -lgfortran -lquadmath -lopenblas -lgomp -lmingw32 -lkernel32 -lm', l_msys); % MinGW style
    % MSVC compatible version
    sys_libs = sprintf('/LIBPATH:. libmx.lib libmex.lib libmat.lib /LIBPATH:"%s" libgfortran.lib libquadmath.lib libopenblas.lib libgomp.lib mingw32.lib kernel32.lib m.lib', l_msys);
