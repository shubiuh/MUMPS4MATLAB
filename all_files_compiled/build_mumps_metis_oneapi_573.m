function build_mumps_metis_oneapi_573(target_arith)
    % =====================================================================
    ...
    superbuild_root = 'D:\trash\WinMumps-4.10.rc2.tar\WinMumps-4.10.rc2\WinMumps-4.10\MUMPS_5.7.3';
    build_dir       = fullfile(superbuild_root, '');
    ...
    lib_dir       = fullfile(build_dir, 'lib');

    metis_src_root = fullfile(superbuild_root, 'parmetis', 'METIS');
    metis_lib_dir  = fullfile('D:\trash\WinMumps-4.10.rc2.tar\WinMumps-4.10.rc2\WinMumps-4.10\lib');
    gklib_lib_dir  = fullfile('D:\trash\WinMumps-4.10.rc2.tar\WinMumps-4.10.rc2\WinMumps-4.10\lib');
    ...
    mumps_libs = {
        fullfile(lib_dir, 'libdmumps.lib'), ...
        fullfile(lib_dir, 'libzmumps.lib'), ...
        fullfile(lib_dir, 'libmumps_common.lib'), ...
        fullfile(lib_dir, 'libmpiseq.lib'), ...
    };
    ...
    mkl_libs = {
        fullfile(mkl_lib_dir, 'mkl_intel_lp64.lib'), ...
        fullfile(mkl_lib_dir, 'mkl_intel_thread.lib'), ...
        fullfile(mkl_lib_dir, 'mkl_core.lib'), ...
        fullfile('C:\OPT\Intel\oneAPI\compiler\2025.3\lib', 'libiomp5md.lib')
    };
    ...
    all_libs = [mumps_libs, metis_libs, mkl_libs];
    ...
    link_libs = [mumps_libs, metis_libs, mkl_libs, sys_libs];
